...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    RegExp_RegExp(source, dotAll) {
      return new A.JSSyntaxRegExp(source, A.JSSyntaxRegExp_makeNative(source, false, true, false, dotAll, false));
    },
    ...
    AgentProfile: function AgentProfile(t0, t1, t2, t3) {
      var _ = this;
      _.id = t0;
      _.displayName = t1;
      _.primaryGoal = t2;
    ...
    Agent: function Agent(t0, t1, t2, t3) {
      var _ = this;
      _.profile = t0;
      _.planner = t1;
      _.relationships = t2;
    ...
    SimulationEngine: function SimulationEngine(t0, t1, t2) {
      this.world = t0;
      this.agents = t1;
      this.relationships = t2;
    },
    RuleBasedLlmPlannerModel: function RuleBasedLlmPlannerModel() {
    },
    LlmBackedPlanner: function LlmBackedPlanner() {
    },
    LlmBackedPlanner__parsePlan_closure: function LlmBackedPlanner__parsePlan_closure(t0) {
      this.locationId = t0;
    },
    LlmBackedPlanner__locationList_closure: function LlmBackedPlanner__locationList_closure() {
    },
    MemoryItem: function MemoryItem(t0, t1, t2, t3) {
      var _ = this;
      _.text = t0;
      _.tick = t1;
      _.importance = t2;
    ...
    MemoryStore: function MemoryStore(t0) {
      this._items = t0;
    },
    MemoryStore_recall_closure: function MemoryStore_recall_closure(t0, t1, t2) {
      this.$this = t0;
      this.currentTick = t1;
      this.queryTokens = t2;
    },
    MemoryStore_recall_closure0: function MemoryStore_recall_closure0() {
    },
    MemoryStore_recall_closure1: function MemoryStore_recall_closure1() {
    },
    MemoryStore__tokenize_closure: function MemoryStore__tokenize_closure() {
    },
    _ScoredMemory: function _ScoredMemory(t0, t1) {
      this.memory = t0;
      this.score = t1;
    },
    PlanAction: function PlanAction(t0, t1) {
      this.locationId = t0;
      this.description = t1;
    },
    HeuristicPlanner: function HeuristicPlanner() {
    },
    HeuristicPlanner__extractKnownLocation_closure: function HeuristicPlanner__extractKnownLocation_closure(t0) {
      this.candidate = t0;
    },
    RelationshipSignal: function RelationshipSignal(t0) {
      this.otherAgentId = t0;
    },
    RelationshipEdge: function RelationshipEdge(t0, t1, t2, t3) {
      var _ = this;
      _.affinity = t0;
      _.trust = t1;
      _.lastUpdatedTick = t2;
      _.interactionCount = t3;
    },
    RelationshipGraph: function RelationshipGraph(t0) {
      this._edges = t0;
    },
    RelationshipGraph_topSignals_closure: function RelationshipGraph_topSignals_closure() {
    },
    RelationshipGraph_topSignals_closure0: function RelationshipGraph_topSignals_closure0() {
    },
    RelationshipGraph__setOneWay_closure: function RelationshipGraph__setOneWay_closure() {
    },
    Location: function Location(t0) {
      this.id = t0;
    },
    WorldEvent: function WorldEvent(t0, t1, t2, t3, t4) {
      var _ = this;
      _.actorId = t0;
      _.locationId = t1;
      _.description = t2;
    ...
    WorldSnapshot: function WorldSnapshot(t0, t1, t2) {
      this.tick = t0;
      this.locations = t1;
      this.recentEvents = t2;
    },
    WorldState: function WorldState(t0, t1) {
      this.locations = t0;
      this._events = t1;
      this._tick = 0;
    },
    main() {
      var $async$goto = 0,
        ...
        $async$handler = 1, $async$errorStack = [], output, events, error, stackTrace, t3, children, relationships, exception, t1, t2, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = document;
              t2 = t1.createElement("pre");
              t2.toString;
              B.PreElement_methods.set$text(t2, "Running simulation...");
              output = t2;
              t2 = t1.body;
              if (t2 != null) {
                t1 = t1.createElement("h2");
                t1.toString;
                B.HeadingElement_methods.set$text(t1, "Town Simulation");
                t3 = type$.JSArray_Element;
                t1 = A._setArrayType(type$.List_Element._as(A._setArrayType([t1, output], t3)).slice(0), t3);
                children = B.BodyElement_methods.get$children(t2);
                children.clear$0(0);
                children.addAll$1(0, t1);
              }
              $async$handler = 3;
              t1 = A._setArrayType([], type$.JSArray_WorldEvent);
              t2 = type$.String;
              relationships = new A.RelationshipGraph(A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.Map_String_RelationshipEdge));
              relationships.setBidirectional$5$a$affinity$b$tick$trust("ava", 0.6, "noah", 0, 0.7);
              relationships.setBidirectional$5$a$affinity$b$tick$trust("ava", 0.4, "liam", 0, 0.55);
              relationships.setBidirectional$5$a$affinity$b$tick$trust("noah", 0.35, "liam", 0, 0.5);
              t3 = type$.JSArray_MemoryItem;
              $async$goto = 6;
              return A._asyncAwait(new A.SimulationEngine(new A.WorldState(B.List_Vd6, t1), A._setArrayType([new A.Agent(B.AgentProfile_JiR, B.C_LlmBackedPlanner, relationships, new A.MemoryStore(A._setArrayType([], t3))), new A.Agent(B.AgentProfile_vm3, B.C_LlmBackedPlanner, relationships, new A.MemoryStore(A._setArrayType([], t3))), new A.Agent(B.AgentProfile_lDx, B.C_LlmBackedPlanner, relationships, new A.MemoryStore(A._setArrayType([], t3)))], type$.JSArray_Agent), relationships).run$1$ticks(4), $async$main);
            case 6:
              // returning from await.
              events = $async$result;
              J.set$text$x(output, J.map$1$1$ax(events, new A.main_closure(), t2).join$1(0, "\n"));
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
            case 3:
              ...
              J.set$text$x(output, "Failed to run simulation: " + A.S(error) + "\n\n" + A.S(stackTrace));
              // goto after finally
              $async$goto = 5;
              break;
            case 2:
  ...
  J.JSString.prototype = {
    split$1(receiver, pattern) {
      ...
      t1 = nativeAnchoredRegExp.exec("").length;
      if (t1 - 2 === 0)
    ...
    _defaultSplit$1(receiver, pattern) {
      var t1, t2, start, $length, match, t3, matchStart, matchEnd,
        result = A._setArrayType([], type$.JSArray_String);
      for (t1 = pattern.allMatches$1(0, receiver), t1 = new A._AllMatchesIterator(t1._re, t1._string, t1.__js_helper$_start), t2 = type$.RegExpMatch, start = 0, $length = 1; t1.moveNext$0();) {
  ...
  A.AgentProfile.prototype = {};
  A.Agent.prototype = {
    perceive$1(snapshot) {
      var t1, t2, t3, t4, t5, t6, _i, $event, t7, t8, existing, socialAffinity, selfAuthored, socialBoost, t9;
      for (t1 = snapshot.recentEvents, t2 = t1.length, t3 = type$.String, t4 = this.memory, t5 = this.profile.id, t6 = this.relationships._edges, _i = 0; _i < t2; ++_i) {
        $event = t1[_i];
        t7 = $event.actorId;
        t8 = t6.$index(0, t5);
        existing = t8 == null ? null : t8.$index(0, t7);
        socialAffinity = existing == null ? null : existing.affinity;
        if (socialAffinity == null)
          socialAffinity = 0;
        selfAuthored = t7 === t5;
        socialBoost = selfAuthored ? 0.15 : socialAffinity * 0.2;
        t8 = t4._memory$_clamp$3((selfAuthored ? 0.7 : 0.5) + socialBoost, 0, 1);
        t9 = A.List_List$of($event.tags, true, t3);
        t9.push($event.locationId);
        t9.push(t7);
        B.JSArray_methods.add$1(t4._items, new A.MemoryItem($event.description, $event.tick, t8, t9));
      }
    },
    act$1(snapshot) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.WorldEvent),
        $async$returnValue, $async$self = this, t1, t2, action, t3;
      var $async$act$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.profile;
              t2 = t1.id;
              $async$goto = 3;
              return A._asyncAwait($async$self.planner.nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals(t2, t1.homeLocationId, $async$self.memory, t1.primaryGoal, snapshot, $async$self.relationships.topSignals$1$agentId(t2)), $async$act$1);
            case 3:
              // returning from await.
              action = $async$result;
              t3 = action.locationId;
              $async$returnValue = new A.WorldEvent(t2, t3, t1.displayName + " at " + t3 + ": " + action.description, snapshot.tick, A._setArrayType([t2, t3, "action"], type$.JSArray_String));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$act$1, $async$completer);
    }
  };
  A.SimulationEngine.prototype = {
    run$1$ticks(ticks) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_WorldEvent),
        $async$returnValue, $async$self = this, t1, t2, t3, t4, t5, t6, i, t7, t8, start, result, result0, snapshot, _i, currentTickEvents, $event;
      var $async$run$1$ticks = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.agents, t2 = $async$self.world, t3 = t2._events, t4 = type$.JSArray_WorldEvent, t5 = type$.Location, t6 = type$.WorldEvent, i = 0;
            case 3:
              // for condition
              if (!(i < ticks)) {
                // goto after for
              ...
              t8 = t3.length;
              start = t8 > 20 ? t8 - 20 : 0;
              result = A.List_List$from(t2.locations, false, t5);
              result.$flags = 3;
              result0 = A.List_List$from(B.JSArray_methods.sublist$1(t3, start), false, t6);
              result0.$flags = 3;
              snapshot = new A.WorldSnapshot(t7, result, result0);
              for (_i = 0; _i < 3; ++_i)
                t1[_i].perceive$1(snapshot);
              currentTickEvents = A._setArrayType([], t4);
              _i = 0;
            case 6:
              // for condition
              if (!(_i < 3)) {
              ...
              $async$goto = 9;
              return A._asyncAwait(t1[_i].act$1(snapshot), $async$run$1$ticks);
            case 9:
              // returning from await.
              $event = $async$result;
              B.JSArray_methods.add$1(t3, $event);
              B.JSArray_methods.add$1(currentTickEvents, $event);
            case 7:
              // for update
              ++_i;
              // goto for condition
            ...
            case 8:
              // after for
              $async$self._updateRelationships$2(currentTickEvents, snapshot.tick);
            case 4:
              // for update
              ++i;
              // goto for condition
            ...
            case 5:
              // after for
              $async$returnValue = A.List_List$unmodifiable(t3, t6);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$run$1$ticks, $async$completer);
    },
    _updateRelationships$2(events, tick) {
      var t1, i, j, j0, t2, first, second, t3;
      type$.List_WorldEvent._as(events);
      for (t1 = this.relationships, i = 0; i < events.length; i = j)
        for (j = i + 1, j0 = j; t2 = events.length, j0 < t2; ++j0) {
          if (!(i < t2))
            return A.ioore(events, i);
          first = events[i];
          second = events[j0];
          if (first.locationId === second.locationId && first.actorId !== second.actorId) {
            t2 = first.actorId;
            t3 = second.actorId;
            t1._bumpOneWay$3$from$tick$to(t2, tick, t3);
            t1._bumpOneWay$3$from$tick$to(t3, tick, t2);
          }
        }
    }
  };
  A.RuleBasedLlmPlannerModel.prototype = {
    complete$2$systemPrompt$userPrompt(_, systemPrompt, userPrompt) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$self = this, friend, goal;
      var $async$complete$2$systemPrompt$userPrompt = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              goal = $async$self._extractTagValue$2(userPrompt, "goal");
              if (goal == null)
                goal = "support the town";
              friend = $async$self._extractTagValue$2(userPrompt, "top_friend");
              if (friend == null)
                friend = "team";
              $async$returnValue = 'location=town_square;action=Advance "' + goal + '" with ' + friend;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$complete$2$systemPrompt$userPrompt, $async$completer);
    },
    _extractTagValue$2($prompt, tag) {
      var t1,
        match = A.RegExp_RegExp(tag + "=([^\\n]+)", false).firstMatch$1($prompt);
      if (match == null)
        return null;
      t1 = match._match;
      if (1 >= t1.length)
        return A.ioore(t1, 1);
      t1 = t1[1];
      return t1 == null ? null : B.JSString_methods.trim$0(t1);
    }
  };
  A.LlmBackedPlanner.prototype = {
    nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals(agentId, fallbackLocationId, memory, primaryGoal, snapshot, socialSignals) {
      return this.nextAction$body$LlmBackedPlanner(agentId, fallbackLocationId, memory, primaryGoal, snapshot, type$.List_RelationshipSignal._as(socialSignals));
    },
    nextAction$body$LlmBackedPlanner(agentId, fallbackLocationId, memory, primaryGoal, snapshot, socialSignals) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.PlanAction),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, raw, parsed, exception, t1, recalled, topFriend, topMemory, systemPrompt, userPrompt, $async$exception;
      var $async$nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = snapshot.tick;
              recalled = memory.recall$3$currentTick$limit$query(t1, 2, primaryGoal);
              topFriend = socialSignals.length !== 0 ? B.JSArray_methods.get$first(socialSignals).otherAgentId : "none";
              topMemory = recalled.length !== 0 ? B.JSArray_methods.get$first(recalled).text : "none";
              systemPrompt = "You are a town-simulation planner. Return exactly: location=<id>;action=<text>";
              userPrompt = "tick=" + t1 + "\nagent=" + agentId + "\ngoal=" + primaryGoal + "\nfallback_location=" + fallbackLocationId + "\nknown_locations=" + $async$self._locationList$1(snapshot) + "\ntop_friend=" + topFriend + "\ntop_memory=" + topMemory;
              $async$handler = 4;
              $async$goto = 7;
              return A._asyncAwait(B.C_RuleBasedLlmPlannerModel.complete$2$systemPrompt$userPrompt(0, systemPrompt, userPrompt), $async$nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals);
            case 7:
              // returning from await.
              raw = $async$result;
              parsed = $async$self._parsePlan$2$raw$snapshot(raw, snapshot);
              if (parsed != null) {
            ...
            case 6:
              // after finally
              $async$returnValue = B.C_HeuristicPlanner.nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals(agentId, fallbackLocationId, memory, primaryGoal, snapshot, socialSignals);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals, $async$completer);
    },
    _parsePlan$2$raw$snapshot(raw, snapshot) {
      var t1, locationId,
        locationMatch = A.RegExp_RegExp("location=([^;]+)", false).firstMatch$1(raw),
        actionMatch = A.RegExp_RegExp("action=(.+)$", true).firstMatch$1(raw);
      if (locationMatch == null || actionMatch == null)
        return null;
      t1 = locationMatch._match;
      if (1 >= t1.length)
        return A.ioore(t1, 1);
      t1 = t1[1];
      t1.toString;
      locationId = B.JSString_methods.trim$0(t1);
      if (!B.JSArray_methods.any$1(snapshot.locations, new A.LlmBackedPlanner__parsePlan_closure(locationId)))
        return null;
      t1 = actionMatch._match;
      if (1 >= t1.length)
        return A.ioore(t1, 1);
      t1 = t1[1];
      t1.toString;
      return new A.PlanAction(locationId, "[llm] " + B.JSString_methods.trim$0(t1));
    },
    _locationList$1(snapshot) {
      var t1 = snapshot.locations,
        t2 = A._arrayInstanceType(t1);
      return new A.MappedListIterable(t1, t2._eval$1("String(1)")._as(new A.LlmBackedPlanner__locationList_closure()), t2._eval$1("MappedListIterable<1,String>")).join$1(0, ",");
    },
    $isPlanner: 1
  };
  A.LlmBackedPlanner__parsePlan_closure.prototype = {
    call$1($location) {
      return type$.Location._as($location).id === this.locationId;
    },
    $signature: 5
  };
  A.LlmBackedPlanner__locationList_closure.prototype = {
    call$1($location) {
      return type$.Location._as($location).id;
    },
    $signature: 14
  };
  A.MemoryItem.prototype = {};
  A.MemoryStore.prototype = {
    recall$3$currentTick$limit$query(currentTick, limit, query) {
      var t1 = this._items,
        t2 = A._arrayInstanceType(t1),
        t3 = t2._eval$1("MappedListIterable<1,_ScoredMemory>"),
        scored = A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("_ScoredMemory(1)")._as(new A.MemoryStore_recall_closure(this, currentTick, this._tokenize$1(query))), t3), true, t3._eval$1("ListIterable.E"));
      B.JSArray_methods.sort$1(scored, new A.MemoryStore_recall_closure0());
      t3 = A.SubListIterable$(scored, 0, A.checkNotNullable(limit, "count", type$.int), A._arrayInstanceType(scored)._precomputed1);
      t2 = t3.$ti;
      t1 = t2._eval$1("MappedListIterable<ListIterable.E,MemoryItem>");
      return A.List_List$of(new A.MappedListIterable(t3, t2._eval$1("MemoryItem(ListIterable.E)")._as(new A.MemoryStore_recall_closure1()), t1), false, t1._eval$1("ListIterable.E"));
    },
    _tokenize$1(input) {
      var t2, t3, t4,
        t1 = A.RegExp_RegExp("[^a-z0-9 ]", false);
      t1 = B.JSString_methods.split$1(A.stringReplaceAllUnchecked(input.toLowerCase(), t1, " "), A.RegExp_RegExp("\\s+", false));
      t2 = A._arrayInstanceType(t1);
      t3 = t2._eval$1("bool(1)")._as(new A.MemoryStore__tokenize_closure());
      t2 = t2._eval$1("WhereIterable<1>");
      t4 = A.LinkedHashSet_LinkedHashSet(t2._eval$1("Iterable.E"));
      t4.addAll$1(0, new A.WhereIterable(t1, t3, t2));
      return t4;
    },
    _overlap$2(a, b) {
      ...
      t1._as(a);
      t1._as(b);
      if (a._collection$_length === 0 || b._collection$_length === 0)
        return 0;
      return a.intersection$1(b)._collection$_length / a._collection$_length;
    },
    _memory$_clamp$3(value, min, max) {
      if (value < min)
        return min;
      if (value > max)
        return max;
  ...
  A.MemoryStore_recall_closure.prototype = {
    call$1(memory) {
      var t1;
      type$.MemoryItem._as(memory);
      t1 = this.$this;
      return new A._ScoredMemory(memory, 0.45 * memory.importance + 0.35 * (1 / (1 + (this.currentTick - memory.tick))) + 0.2 * t1._overlap$2(t1._tokenize$1(memory.text), this.queryTokens));
    },
    $signature: 15
  };
  A.MemoryStore_recall_closure0.prototype = {
    call$2(a, b) {
      var t1 = type$._ScoredMemory;
      t1._as(a);
      return B.JSNumber_methods.compareTo$1(t1._as(b).score, a.score);
    },
    $signature: 16
  };
  A.MemoryStore_recall_closure1.prototype = {
    call$1(entry) {
      return type$._ScoredMemory._as(entry).memory;
    },
    $signature: 17
  };
  A.MemoryStore__tokenize_closure.prototype = {
    call$1(token) {
      return A._asString(token).length !== 0;
    },
    $signature: 18
  };
  A._ScoredMemory.prototype = {};
  A.PlanAction.prototype = {};
  A.HeuristicPlanner.prototype = {
    nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals(agentId, fallbackLocationId, memory, primaryGoal, snapshot, socialSignals) {
      return this.nextAction$body$HeuristicPlanner(agentId, fallbackLocationId, memory, primaryGoal, snapshot, type$.List_RelationshipSignal._as(socialSignals));
    },
    nextAction$body$HeuristicPlanner(agentId, fallbackLocationId, memory, primaryGoal, snapshot, socialSignals) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.PlanAction),
        $async$returnValue, $async$self = this, memoryLocation, selectedLocationId, socialHint, memoryHint, recalled;
      var $async$nextAction$6$agentId$fallbackLocationId$memory$primaryGoal$snapshot$socialSignals = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              recalled = memory.recall$3$currentTick$limit$query(snapshot.tick, 3, primaryGoal);
              if (recalled.length !== 0) {
                memoryLocation = $async$self._extractKnownLocation$2$snapshot$tags(snapshot, B.JSArray_methods.get$first(recalled).tags);
                selectedLocationId = memoryLocation != null ? memoryLocation : fallbackLocationId;
              } else
                selectedLocationId = fallbackLocationId;
              socialHint = socialSignals.length !== 0 ? "with " + B.JSArray_methods.get$first(socialSignals).otherAgentId : "solo";
              memoryHint = recalled.length !== 0 ? 'informed by memory: "' + B.JSArray_methods.get$first(recalled).text + '"' : "based on baseline routine";
              $async$returnValue = new A.PlanAction(selectedLocationId, 'Work on "' + primaryGoal + '" ' + socialHint + " (" + memoryHint + ")");
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    _extractKnownLocation$2$snapshot$tags(snapshot, tags) {
      var t1, t2, _i, candidate;
      type$.List_String._as(tags);
      for (t1 = tags.length, t2 = snapshot.locations, _i = 0; _i < tags.length; tags.length === t1 || (0, A.throwConcurrentModificationError)(tags), ++_i) {
        candidate = tags[_i];
        if (B.JSArray_methods.any$1(t2, new A.HeuristicPlanner__extractKnownLocation_closure(candidate)))
          return candidate;
      }
      return null;
    },
  ...
  A.HeuristicPlanner__extractKnownLocation_closure.prototype = {
    call$1($location) {
      return type$.Location._as($location).id === this.candidate;
    },
    $signature: 5
  };
  A.RelationshipSignal.prototype = {};
  A.RelationshipEdge.prototype = {};
  A.RelationshipGraph.prototype = {
    setBidirectional$5$a$affinity$b$tick$trust(a, affinity, b, tick, trust) {
      var _this = this;
      _this._setOneWay$3$edge$from$to(new A.RelationshipEdge(_this._clamp$3(affinity, -1, 1), _this._clamp$3(trust, 0, 1), tick, 0), a, b);
      _this._setOneWay$3$edge$from$to(new A.RelationshipEdge(_this._clamp$3(affinity, -1, 1), _this._clamp$3(trust, 0, 1), tick, 0), b, a);
    },
    edge$2(from, to) {
      var t1 = this._edges.$index(0, from);
      return t1 == null ? null : t1.$index(0, to);
    },
    topSignals$1$agentId(agentId) {
      var t1, entries, t2, t3,
        outgoing = this._edges.$index(0, agentId);
      if (outgoing == null || outgoing.__js_helper$_length === 0)
        return B.List_empty;
      t1 = outgoing.$ti._eval$1("LinkedHashMapEntriesIterable<1,2>");
      entries = A.List_List$of(new A.LinkedHashMapEntriesIterable(outgoing, t1), true, t1._eval$1("Iterable.E"));
      B.JSArray_methods.sort$1(entries, new A.RelationshipGraph_topSignals_closure());
      t1 = A.SubListIterable$(entries, 0, A.checkNotNullable(3, "count", type$.int), A._arrayInstanceType(entries)._precomputed1);
      t2 = t1.$ti;
      t3 = t2._eval$1("MappedListIterable<ListIterable.E,RelationshipSignal>");
      return A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("RelationshipSignal(ListIterable.E)")._as(new A.RelationshipGraph_topSignals_closure0()), t3), false, t3._eval$1("ListIterable.E"));
    },
    _bumpOneWay$3$from$tick$to(from, tick, to) {
      var t1, t2, _this = this,
        current = _this.edge$2(from, to);
      if (current == null)
        current = B.RelationshipEdge_2HI;
      t1 = _this._clamp$3(current.affinity + 0.03, -1, 1);
      t2 = _this._clamp$3(current.trust + 0.02, 0, 1);
      _this._setOneWay$3$edge$from$to(new A.RelationshipEdge(t1, t2, tick, current.interactionCount + 1), from, to);
    },
    _setOneWay$3$edge$from$to(edge, from, to) {
      var t1 = this._edges;
      t1.putIfAbsent$2(from, new A.RelationshipGraph__setOneWay_closure());
      t1.$index(0, from).$indexSet(0, to, edge);
    },
    _clamp$3(value, min, max) {
      if (value < min)
        return min;
      if (value > max)
        return max;
  ...
  A.RelationshipGraph_topSignals_closure.prototype = {
    call$2(a, b) {
      var t2, t3,
        t1 = type$.MapEntry_String_RelationshipEdge;
      t1._as(a);
      t1._as(b);
      t1 = a.value;
      t2 = t1.affinity;
      t1 = t1.trust;
      t3 = b.value;
      return B.JSNumber_methods.compareTo$1(t3.affinity * 0.6 + t3.trust * 0.4, t2 * 0.6 + t1 * 0.4);
    },
    $signature: 19
  };
  A.RelationshipGraph_topSignals_closure0.prototype = {
    call$1(entry) {
      type$.MapEntry_String_RelationshipEdge._as(entry);
      entry.value.toString;
      return new A.RelationshipSignal(entry.key);
    },
    $signature: 20
  };
  A.RelationshipGraph__setOneWay_closure.prototype = {
    call$0() {
      return A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.RelationshipEdge);
    },
    $signature: 21
  };
  A.Location.prototype = {};
  A.WorldEvent.prototype = {};
  A.WorldSnapshot.prototype = {};
  A.WorldState.prototype = {};
  A.main_closure.prototype = {
    call$1($event) {
      type$.WorldEvent._as($event);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.ImmutableListMixin, A.FixedSizeListIterator, A.AgentProfile, A.Agent, A.SimulationEngine, A.RuleBasedLlmPlannerModel, A.LlmBackedPlanner, A.MemoryItem, A.MemoryStore, A._ScoredMemory, A.PlanAction, A.HeuristicPlanner, A.RelationshipSignal, A.RelationshipEdge, A.RelationshipGraph, A.Location, A.WorldEvent, A.WorldSnapshot, A.WorldState]);
    ...
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.WhereIterable, A._AllMatchesIterable]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BodyElement, A.FormElement, A.HeadingElement, A.PreElement, A.SelectElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(@)", "~(~())", "Null()", "Null(Object,StackTrace)", "bool(Location)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "~(Object?,Object?)", "String(Location)", "_ScoredMemory(MemoryItem)", "int(_ScoredMemory,_ScoredMemory)", "MemoryItem(_ScoredMemory)", "bool(String)", "int(MapEntry<String,RelationshipEdge>,MapEntry<String,RelationshipEdge>)", "RelationshipSignal(MapEntry<String,RelationshipEdge>)", "Map<String,RelationshipEdge>()", "String(WorldEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CDataSection":"CharacterData","Text":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Pattern":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"SubListIterable":{"ListIterable":["1"],"Iterable":["1"],"ListIterable.E":"1","Iterable.E":"1"},"ListIterator":{"Iterator":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2","Iterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"Map":["1","2"]},"LinkedHashMapEntriesIterable":{"Iterable":["MapEntry<1,2>"],"Iterable.E":"MapEntry<1,2>"},"LinkedHashMapEntryIterator":{"Iterator":["MapEntry<1,2>"]},"JSSyntaxRegExp":{"RegExp":[],"Pattern":[]},"_MatchImplementation":{"RegExpMatch":[]},"_AllMatchesIterable":{"Iterable":["RegExpMatch"],"Iterable.E":"RegExpMatch"},"_AllMatchesIterator":{"Iterator":["RegExpMatch"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"AsyncError":{"Error":[]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetBase":["1"],"Set":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"ListBase":{"List":["1"],"Iterable":["1"]},"MapBase":{"Map":["1","2"]},"SetBase":{"Set":["1"],"Iterable":["1"]},"_SetBase":{"SetBase":["1"],"Set":["1"],"Iterable":["1"]},"int":{"num":[]},"List":{"Iterable":["1"]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Element":{"Node":[]},"HtmlElement":{"Element":[],"Node":[]},"AnchorElement":{"Element":[],"Node":[]},"AreaElement":{"Element":[],"Node":[]},"BodyElement":{"Element":[],"Node":[]},"CharacterData":{"Node":[]},"_ChildrenElementList":{"ListBase":["Element"],"List":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"FormElement":{"Element":[],"Node":[]},"HeadingElement":{"Element":[],"Node":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"PreElement":{"Element":[],"Node":[]},"SelectElement":{"Element":[],"Node":[]},"FixedSizeListIterator":{"Iterator":["1"]},"LlmBackedPlanner":{"Planner":[]},"HeuristicPlanner":{"Planner":[]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_Agent: findType("JSArray<Agent>"),
      JSArray_Element: findType("JSArray<Element>"),
      JSArray_MemoryItem: findType("JSArray<MemoryItem>"),
      JSArray_String: findType("JSArray<String>"),
      JSArray_WorldEvent: findType("JSArray<WorldEvent>"),
      JSArray_dynamic: findType("JSArray<@>"),
      JSNull: findType("JSNull"),
      JavaScriptFunction: findType("JavaScriptFunction"),
      JavaScriptIndexingBehavior_dynamic: findType("JavaScriptIndexingBehavior<@>"),
      List_Element: findType("List<Element>"),
      List_RelationshipSignal: findType("List<RelationshipSignal>"),
      List_String: findType("List<String>"),
      List_WorldEvent: findType("List<WorldEvent>"),
      List_dynamic: findType("List<@>"),
      Location: findType("Location"),
      MapEntry_String_RelationshipEdge: findType("MapEntry<String,RelationshipEdge>"),
      Map_String_RelationshipEdge: findType("Map<String,RelationshipEdge>"),
      MemoryItem: findType("MemoryItem"),
      Null: findType("Null"),
      Object: findType("Object"),
      PlanAction: findType("PlanAction"),
      Record: findType("Record"),
      RegExpMatch: findType("RegExpMatch"),
      RelationshipEdge: findType("RelationshipEdge"),
      ...
      WorldEvent: findType("WorldEvent"),
      _Future_dynamic: findType("_Future<@>"),
      _ScoredMemory: findType("_ScoredMemory"),
      bool: findType("bool"),
  ...
  (function constants() {
    ...
    B.AgentProfile_JiR = new A.AgentProfile("ava", "Ava", "ship the town simulation feature", "office");
    B.AgentProfile_lDx = new A.AgentProfile("liam", "Liam", "build playful social systems", "park");
    B.AgentProfile_vm3 = new A.AgentProfile("noah", "Noah", "mentor teammates and improve reliability", "cafe");
    B.C_HeuristicPlanner = new A.HeuristicPlanner();
...
;
    B.C_RuleBasedLlmPlannerModel = new A.RuleBasedLlmPlannerModel();
    B.C_LlmBackedPlanner = new A.LlmBackedPlanner();
    B.C__RootZone = new A._RootZone();
    B.C__StringStackTrace = new A._StringStackTrace();
    B.Location_town_square = new A.Location("town_square");
    B.Location_cafe = new A.Location("cafe");
    B.Location_office = new A.Location("office");
    B.Location_park = new A.Location("park");
    B.List_Vd6 = A._setArrayType(makeConstList([B.Location_town_square, B.Location_cafe, B.Location_office, B.Location_park]), A.findType("JSArray<Location>"));
    B.List_empty = A._setArrayType(makeConstList([]), A.findType("JSArray<RelationshipSignal>"));
    B.RelationshipEdge_2HI = new A.RelationshipEdge(0, 0.2, 0, 0);
  })();
